        ...
        <AnimatePresence>
            ...
            >
                ...
                <div className={`pointer-events-auto relative w-full h-full md:max-h-[650px] bg-white/95 dark:bg-gray-900/95 backdrop-blur-2xl rounded-[32px] shadow-2xl border border-white/50 dark:border-gray-700/50 overflow-hidden flex flex-col ${isTyping ? 'ring-2 ring-indigo-400/50' : ''}`}>
                    ...
                    {/* Reusable AppHeader synced with internal scroll */}
                    <AppHeader 
                    ...
                    <div 
                        ...
                        className="flex-1 overflow-y-auto scroll-smooth overscroll-contain pb-4"
                    >
                        <ChatInterface
                            messages={messages}
                            isTyping={isTyping}
                    ...
                    {/* Chat Input Bar */}
                    <div className="p-2 border-t border-black/5 dark:border-white/5 bg-white/50 dark:bg-gray-900/50 backdrop-blur-md">
                        <ChatInputBar
                            onSendMessage={sendMessage}
                            isTyping={isTyping}
                        />
