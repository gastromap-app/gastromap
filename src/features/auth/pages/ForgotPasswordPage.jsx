            ...
            <div className="hidden lg:flex lg:w-[45%] relative bg-black text-white p-12 flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10 max-w-md">
                    <h1 className="text-5xl font-bold leading-tight mb-8">
                        Reset your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">password</span>
                    </h1>
                        ...
                        <>
                            ...
                            <motion.div variants={itemVariants} className="mt-8 text-center">
                                <p className="text-gray-500 text-sm">
                                    Remember your password? <Link to="/auth/login" className="font-bold text-blue-600 hover:text-blue-700">Sign in</Link>
                                </p>
                            </motion.div>
                        </>
                    )}
