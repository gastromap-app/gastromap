...
const AIGuidePage = () => {
    ...
    // Lock body scroll to prevent iOS Safari from shifting the page
    useEffect(() => {
        const orig = document.body.style.cssText
        document.body.style.cssText = `${orig}; position: fixed; width: 100%; overflow: hidden;`
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Bottom spacer so last message doesn't hide behind input */}
                <div className="h-4 flex-shrink-0" />
            </div>

            {/* Input bar — BottomNav style */}
            <div
                className="relative z-30 px-4 flex-shrink-0 md:px-3 pt-1"
                style={{
