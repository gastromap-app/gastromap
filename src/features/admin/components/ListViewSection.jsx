            ...
            <div className="grid grid-cols-1 gap-4 lg:hidden p-5 pb-32">
                {filtered && filtered.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-slate-50/50 dark:bg-[hsl(220,20%,9%)]/20 rounded-[32px] border border-dashed border-slate-200 dark:border-white/[0.06]">
                        <p className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">{t('admin.table.no_objects')}</p>
                    </div>
                )}
            </div>
                ...
                <table className="w-full text-left border-collapse min-w-[1000px]">
                    <thead>
                        <tr className="bg-slate-50/50 dark:bg-[hsl(220,20%,6%)]/50 border-b border-slate-50 dark:border-white/[0.03]">
                            <th className="px-6 py-5 text-[10px] font-black uppercase text-slate-400 dark:text-[hsl(220,10%,55%)] tracking-[0.2em] pl-10 lg:pl-12">{t('admin.table.object')}</th>
                            <th className="px-6 py-5 text-[10px] font-black uppercase text-slate-400 dark:text-[hsl(220,10%,55%)] tracking-[0.2em]">{t('admin.table.location')}</th>
                            <th className="px-6 py-5 text-[10px] font-black uppercase text-slate-400 dark:text-[hsl(220,10%,55%)] tracking-[0.2em]">{t('admin.table.rating')}</th>
                            <th className="px-6 py-5 text-[10px] font-black uppercase text-slate-400 dark:text-[hsl(220,10%,55%)] tracking-[0.2em]">{t('admin.table.status')}</th>
