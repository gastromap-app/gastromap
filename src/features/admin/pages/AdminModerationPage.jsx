    ...
    return (
        <div className="space-y-6 lg:space-y-8 pb-12 font-sans">
            ...
            <div className="flex gap-3">
                ...
                <button className="h-10 px-3 flex items-center gap-2 rounded-2xl border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-indigo-500 hover:border-indigo-300 transition-all">
                    <Filter size={14} />
