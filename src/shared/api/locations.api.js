...
export async function getLocations(filters = {}) {
    ...
    const ANON_COLS = 'id,title,description,address,city,country,lat,lng,category,image_url,google_photos,google_rating,rating,price_range,opening_hours,cuisine_types,status,google_place_id,vibe,tags,special_labels,amenities,dietary_options,best_for,has_wifi,has_outdoor_seating,created_at,updated_at'
...
export async function getLocation(id, { adminMode = false } = {}) {
    ...
    const ANON_COLS = 'id,title,description,address,city,country,lat,lng,category,image_url,google_photos,google_rating,rating,price_range,opening_hours,cuisine_types,status,google_place_id,vibe,tags,special_labels,amenities,dietary_options,best_for,has_wifi,has_outdoor_seating,website,created_at,updated_at'
